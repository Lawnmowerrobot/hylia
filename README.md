...
Hylia is a lightweight [Eleventy](https://11ty.io) starter  with [Netlify CMS](https://www.netlifycms.org/) pre-configured, so that you can one-click install a progressive, accessible blog in minutes. 
